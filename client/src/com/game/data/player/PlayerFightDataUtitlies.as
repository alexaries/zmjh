package com.game.data.player
{
	...
	public class PlayerFightDataUtitlies
	{
		public static function convertPlayerToBattleData(player:*) : Object
		{
		...
		public static function getBattleWe(player:*, role:RoleInfo, type:String) : Battle_we
		{
			...
			battle.fight_soul_ats_lv = (type == FightConfig.NONE_POS || type == "") ? 0 : (player.strengthInfo[type] as StrengthDetail).ats;
			battle.fight_soul_adf_lv = (type == FightConfig.NONE_POS || type == "") ? 0 : (player.strengthInfo[type] as StrengthDetail).adf;
