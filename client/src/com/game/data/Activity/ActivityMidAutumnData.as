package com.game.data.Activity
{
	...
	public class ActivityMidAutumnData extends Base
	{
		private static const URLNAME:String = "http://huodong.4399.com/2013/zhongqiu/api.php?";
		...
		public function ActivityMidAutumnData()
		{
			initURL();
		}
		...
		{
			var str:String = "code=" + activityStr + "&gametype=zmjh"
