...
{
	public class Battle_enemy extends Object
	{
		
		public var useGlowing:Number;
		...
		/**
		 * 关联equipment_Strengthen表的weapon强化等级加成
		 */
		public var equipment_weapon_lv:int;
		...
		/**
		 * 关联equipment_Strengthen表的thing强化等级加成
		 */
		public var equipment_thing_lv:int;
		...
		/**
		 * 关联equipment_Strengthen表的clothes强化等级加成
		 */
		public var equipment_clothes_lv:int;
		...
		public function assign(data:XML) : void
		{
			...
			equipment_weapon_lv = data.@equipment_weapon_lv
			...
			equipment_thing_lv = data.@equipment_thing_lv
			...
			equipment_clothes_lv = data.@equipment_clothes_lv
			...
			enemy_quality = data.@enemy_quality
