package com.game.view.icon
{
	...
	public class IconView extends BaseView implements IView
	{
		...
		protected function initTexture() : void
		{
			if (!_titleTxAtlas)
			{
				var textureXML:XML = getXMLData(V.ICON, GameConfig.ICON_RES, "icon");
				var obj:* = getAssetsObject(V.ICON, GameConfig.ICON_RES, "Textures");
