package com.game.view.map
{
	...
	public class MapUtils
	{
		 ...
		 * 
		 */		
		public static function getRoadInfo(startNode:Node, step:uint, roads:Vector.<Prop>) : SingleLineInfo
		{
		...
		private static function getCurNode(roads:Vector.<Prop>, curNode:Node) : Vector.<Node>
		{
			var nodes:Vector.<Node> = new Vector.<Node>();
			
			var node:Node;
			for each(var prop:Prop in roads)
			{
