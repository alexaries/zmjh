package com.game.view.map
{
	...
	public class TDmapInfo
	{
		 ...
		 * 路点 
		 */		
		private var _roadItems:Vector.<TDprop>;
		public function get roadItems() : Vector.<TDprop>
		{
			return _roadItems;
		}
		...
		public function TDmapInfo(view:View, loadBaseName:String, level:String)
		{
			_view = view;
		...
		{
			_roadItems = new Vector.<TDprop>();
			
			var roadInfo:TDprop;
			for each(var item:XML in items)
			{
				roadInfo = new TDprop(_view.towerDefence);
