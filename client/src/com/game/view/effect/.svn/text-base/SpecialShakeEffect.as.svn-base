package com.game.view.effect
{
	...
	public class SpecialShakeEffect
	{
		private static const INTERVAL_TIME:Number = .02;
		private static const ROTATION:Number = .2;
		...
		public function SpecialShakeEffect(obj_1:DisplayObject)
		{
			_isPlay = false;
			...
			_changePivotX_1 = _thisObj_1.pivotX * .8 * ROTATION;
			_changePivotY_1 = _thisObj_1.pivotY * .8 * ROTATION;
		...
		public function play() : void
		{
			if(!_isPlay)
			{
				...
				_thisObj_1.y = _startY_1 + _changePivotX_1 * .8;
		...
		private function onStartFun() : void
		{
			...
			_thisObj_1.x = _startX_1 - _changePivotX_1 * .8;
