package com.game.view.guide
{
	...
	public class FirstGuideView extends BaseView implements IView
	{
		...
		public function FirstGuideView()
		{
			_layer = LayerTypes.TOP;
			_moduleName = V.FIRST_GUIDE;
		 ...
		 * 
		 */		
		public function firstGuide() : void
		{
			_wordNow = 0;
			_guideNow = null;
			var guideType:Vector.<GuideItemData> = _guideData.allGuide.firstItem;
			
			_guideNow = guideType[0];
			
			if(Data.instance.guide.guideInfo.checkGuideInfo("first", "first")) return;
		...
		private var _isFightStart:Boolean = false;
		public function get isFightStart() : Boolean
		{
			return _isFightStart;
		}
		public function set isFightStart(value:Boolean) : void
		{
			_isFightStart = value;
		}
		
		private var _isBossStart:Boolean = false;
		public function get isBossStart() : Boolean
		{
			return _isBossStart;
		}
		public function set isBossStart(value:Boolean) : void
		{
			_isBossStart = value;
		}
		...
		private function onFunContinue(e:TouchEvent) : void
		{
			...
			{
				var name:String = getTextureName(touch.target);trace(name);
		...
		public function showRoleBtn() : void
		{
			_view.toolbar.onStartFly();
		}
		...
		{
			_positionXML = getXMLData(V.GUIDE, GameConfig.GUIDE_RES, "FirstGuidePosition");
		}
