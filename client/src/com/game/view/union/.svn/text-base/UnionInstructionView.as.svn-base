package com.game.view.union
{
	...
	public class UnionInstructionView extends BaseView implements IView
	{
		private var _positionXML:XML;
		public function UnionInstructionView()
		{
			_moduleName = V.INSTRUCTION_UNION;
		...
		override protected function getTextures(name:String, type:String) : Vector.<Texture>
		{
			...
			{
				textures = _view.strength.titleTxAtlas.getTextures(name);
			}
			return textures;
		}
		...
		override protected function getTexture(name:String, type:String) : Texture
		{
			...
			{
				texture = _view.strength.titleTxAtlas.getTexture(name);
			}
