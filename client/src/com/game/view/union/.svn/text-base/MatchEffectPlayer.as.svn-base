package com.game.view.union
{
	...
	public class MatchEffectPlayer extends BaseSprite
	{
		...
		public function MatchEffectPlayer()
		{
		}
		...
		private function initUI() : void
		{
			...
			View.instance.match_game.juggle.add(_content);
		...
		public function clear() : void
		{
			...
			View.instance.match_game.juggle.remove(_content);
