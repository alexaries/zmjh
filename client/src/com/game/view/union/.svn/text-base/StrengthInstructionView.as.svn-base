package com.game.view.union
{
	...
	public class StrengthInstructionView extends BaseView implements IView
	{
		private var _positionXML:XML;
		public function StrengthInstructionView()
		{
			_moduleName = V.INSTRUCTION_STRENGTH;
		...
		override protected function getTextures(name:String, type:String) : Vector.<Texture>
		{
			...
			{
				textures = _view.union.titleTxAtlas.getTextures(name);
			}
			return textures;
		}
		...
		override protected function getTexture(name:String, type:String) : Texture
		{
			...
			{
				texture = _view.union.titleTxAtlas.getTexture(name);
			}
