package com.game.view.Role
{
	...
	public class OneFormationComponent extends Component
	{
		private var _glass:Image;
		
		public function OneFormationComponent(item:XML, titleTxAtlas:TextureAtlas)
		{
		...
		private function onRoleImageTouch(e:TouchEvent) : void
		{
			...
			{
				panel.parent.addChildAt(panel, panel.parent.numChildren-4);
			}
		}
		...
		{
			return new OneFormationComponent(_configXML, _titleTxAtlas);
		}
