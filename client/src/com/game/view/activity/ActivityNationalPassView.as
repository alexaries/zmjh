package com.game.view.activity
{
	...
	public class ActivityNationalPassView extends BaseView implements IView
	{
		public function ActivityNationalPassView()
		{
			_layer = LayerTypes.TIP;
			_moduleName = V.NATIONAL_PASS;
		...
		{
			var texture:Texture = _view.icon.interfaces(InterfaceTypes.GetTexture, "props_54");
			Data.instance.pack.addNoneProp(54, 1);
			_itemNameTF.text = "“普天同庆”碎片";
