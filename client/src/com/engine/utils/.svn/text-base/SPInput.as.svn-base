package com.engine.utils
{
	...
	public class SPInput
	{
		...
		{
			if (!_enabled && LayerManager.instance.stage)
			{
				LayerManager.instance.stage.addEventListener(KeyboardEvent.KEY_DOWN, onKeyDown);
				LayerManager.instance.stage.addEventListener(KeyboardEvent.KEY_UP, onKeyUp);
				_enabled = true;
			}
		}
