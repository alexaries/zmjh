...
package starling.display
{
    ...
    public class Button extends DisplayObjectContainer
    {
		...
		// jobin
		public function resizeJugle() : void
		{
			mBackground.readjustSize();
		}
        ...
        private function onTouch(event:TouchEvent):void
        {
            ...
            if (touch.phase == TouchPhase.BEGAN && !mIsDown)
            {
				...
				// 修改   居中
				mBackground.x = this.mUpState.width - this.mDownState.width >> 1;
				mBackground.y = this.mUpState.height - this.mDownState.height >> 1;
            }
