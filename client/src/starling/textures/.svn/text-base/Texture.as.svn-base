...
package starling.textures
{
    ...
    public class Texture
    {
		...
		// jobin generateMipMaps:Boolean=true 改成  generateMipMaps:Boolean=false
        ...
        public static function fromTexture(texture:Texture, region:Rectangle=null, frame:Rectangle=null, name:String=""):Texture
        {
